...
function animateTitle() {
	...
	setTimeout(function () {
		$('#title-logo').attr('src', 'assets/title-yellow.png');
		$('#title-text').html(
			'MULTIPLICATION<span style = "margin-left: 11px;"></span>METHO<span class = "code">10</span>N'
		);
	...
	setTimeout(function () {
		$('#title-logo').attr('src', 'assets/title.png');
		$('#title-text').html('MULTIPLICATION<span style = "margin-left: 11px;"></span>METHOOD');
